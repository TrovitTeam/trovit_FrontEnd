        ...
        <Row>
          <Col className="offset-s2" s={8}>
            <Input
              ...
              data-length="45"
              minLength={3}
              error={this.handleDataError(this.state.productName, 3)}
            />
            <Input
              s={12}
              name="producType"
              label="Product Type"
              value={this.state.producType}
              onChange={this.handleChange}
              validate
              data-length="45"
              minLength={3}
              error={this.handleDataError(this.state.producType, 3)}
            />
            <Input
              s={12}
              name="price"
              ...
              data-length="45"
              minLength={3}
              error={this.handleDataError(this.state.price, 3)}
            />
            <Input
              s={12}
              name="quantity"
              ...
              data-length="45"
              minLength={1}
              error={this.handleDataError(this.state.price, 1)}
            />
            <Input
              s={12}
              name="brand"
              ...
              data-length="45"
              minLength={3}
              error={this.handleDataError(this.state.brand, 3)}
            />
            <Input
              s={12}
              name="description"
              ...
              validate
              minLength={10}
              error={this.handleDataError(this.state.description, 10)}
            />
          </Col>
        </Row>
